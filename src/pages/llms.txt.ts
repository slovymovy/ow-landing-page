...
import { languageSlugs, languages, site } from '../data/site';
...
export const GET: APIRoute = () => {
  ...
  const localized = [
    `- ${site.origin}/pl/ - Polish-language OpenWords homepage.`,
    `- ${site.origin}/nl/ - Dutch-language OpenWords homepage.`,
    `- ${site.origin}/ru/ - Russian-language OpenWords homepage.`
  ].join('\n');
  ...
  return new Response(
    [
      '# OpenWords',
      '',
      'OpenWords is a vocabulary learning app for Dutch, English, Polish, and Russian. It combines a deep dictionary, one-tap saved word cards, spaced repetition, and offline study.',
      '',
      'The app is free to use for the core vocabulary workflow and does not require account registration.',
      '',
      'Core product facts:',
      '- Supported platforms: iOS and Android.',
      '- Supported languages: Dutch, English, Polish, Russian.',
