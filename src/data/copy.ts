...
export const homeCopy = {
  en: {
    ...
    subtitle: 'OpenWords is a vocabulary app for Dutch, English, Polish, and Russian. Look up a word, save the exact meaning in one tap, and review it later with spaced repetition.',
    ...
    loop: 'Search a word you just read or heard. OpenWords shows every meaning it carries — not one generic translation. Pick the sense that matches your sentence and tap save.',
    ...
    howItWorksTitle: "From any word you meet to a word you'll keep.",
    ...
    learnVerb: 'Learn',
    languagesTitle: 'Pick a language.',
    ...
    ctaSub: "Free. No account. Works offline. Everything you need to turn every word you meet into one you'll remember.",
  ...
  pl: {
    ...
    subtitle: 'OpenWords to intuicyjna aplikacja do słownictwa dla języka niderlandzkiego, angielskiego, polskiego i rosyjskiego. Wyszukaj słowo, zapisz jego dokładne znaczenie jednym dotknięciem i powtarzaj je później metodą powtórek interwałowych.',
    ...
    loop: 'Znajdź słówko, które przed chwilą przeczytałeś lub usłyszałeś. OpenWords pokazuje każde jego rzeczywiste znaczenie – a nie jedno ogólne tłumaczenie. Wybierz kontekst pasujący do Twojego zdania i stuknij „Zapisz”.',
    ...
    howItWorksTitle: 'Od przypadkowo napotkanego słowa do wyrazu, który zostanie z Tobą na zawsze.',
    howItWorksSub: 'Zero konfiguracji. Bez tworzenia talii. Bez ręcznego klepania fiszek. Słownik sam staje się fiszką.',
    howStepChips: ['01 Wyszukaj', '02 Zapisz', '03 Ćwicz', '04 Śledź postępy'],
    ...
    finalCta: 'Zacznij budować swój własny słownik.',
    ctaSub: 'Za darmo. Bez konta. Działa offline. Wszystko, czego potrzebujesz, by zmienić każde napotkane słowo w wiedzę, która zostanie z Tobą na stałe.',
  ...
  nl: {
    ...
    navDownload: 'Download',
    eyebrow: 'Beschikbaar voor iOS en Android',
    ...
    subtitle: 'OpenWords is een slimme woordenschat-app voor Nederlands, Engels, Pools en Russisch. Zoek een woord op, bewaar de juiste betekenis met één tik en herhaal het op het perfecte moment met gespreide herhaling.',
    ...
    loopTitle: 'Zoek elk woord op in een paar seconden.',
    loop: 'Zoek een woord dat je net hebt gelezen of gehoord. OpenWords toont alle specifieke betekenissen – niet slechts één algemene vertaling. Kies de betekenis die past bij jouw context en tik op opslaan.',
    ...
    howItWorksTitle: 'Van een woord dat je toevallig tegenkomt naar een woord dat je onthoudt.',
    howItWorksSub: 'Geen configuratie. Geen decks bouwen. Geen handmatige flashcards maken. Het woordenboek is de flashcard.',
    howStepChips: ['01 Opzoeken', '02 Opslaan', '03 Leren', '04 Voortgang volgen'],
    ...
    ctaSub: 'Gratis. Geen account. Werkt offline. Alles wat je nodig hebt om van elk nieuw woord een woord te maken dat je nooit meer vergeet.',
  ...
  ru: {
    ...
    subtitle: 'OpenWords — это умное приложение для расширения словарного запаса в английском, нидерландском, польском и русском языках. Найдите незнакомое слово, сохраните его точное значение одним нажатием и эффективно запоминайте с помощью интервальных повторений.',
    ...
    loopTitle: 'Найдите любое слово за пару секунд.',
    loop: 'Ищите слово, которое вы только что прочитали или услышали. OpenWords показывает все контекстные значения слова, а не один общий перевод. Выберите именно тот смысл, который подходит под ваше предложение, и нажмите «Сохранить».',
    ...
    howItWorksTitle: 'От случайно встреченного слова — к слову, которое останется с вами навсегда.',
    howItWorksSub: 'Ноль настроек. Без создания колод. Без ручного добавления карточек. Словарь сам становится вашей карточкой.',
    howStepChips: ['01 Найдите', '02 Сохраните', '03 Учите', '04 Отслеживайте'],
    ...
    finalCta: 'Начните собирать свой собственный словарь.',
    ctaSub: 'Бесплатно. Без регистрации. Офлайн. Всё, что нужно, чтобы превратить любое встреченное слово в знание, которое останется с вами навсегда.',
